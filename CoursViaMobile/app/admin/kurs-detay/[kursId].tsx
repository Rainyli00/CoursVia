...
import type {
    MobileAdminKursBolumItem,
    MobileAdminKursDersItem,
    MobileAdminKursDetayResponse,
} from "@/src/types/admin";

// Admin kurs detay ekranı.
// Mobil V1'de kurs onay/red yoktur, sadece görüntüleme vardır.
export default function AdminKursDetayScreen() {
    const params = useLocalSearchParams<{
        kursId?: string | string[];
    }>();

    // Kurs detay cevabı tek state'te tutulur; hero, sınav ve içerik alanları buradan beslenir.
    const [detay, setDetay] = useState<MobileAdminKursDetayResponse | null>(null);
    ...
    // Kurs detayını API'den getirir; refresh sırasında tam ekran loading göstermez.
    async function kursDetayGetir(refreshMi = false) {
        ...
        try {
            ...
            const response = await api.get<MobileAdminKursDetayResponse>(
                `/api/mobile/admin/kurslar/${kursId}`
            );
    ...
    return (
        <PanelLayout
            title="Kurs Detayı"
            subtitle="Kursun genel bilgilerini, sınavını ve içerik yapısını görüntüleyebilirsin."
        ...
        >
            ...
            >
                <Text style={styles.backButtonText}>← Kurslara Dön</Text>
            </Pressable>
            ...
            <View style={styles.heroCard}>
                ...
                <View style={styles.metaGrid}>
                    ...
                    />
                    <InfoCard title="Yorum" value={String(detay.degerlendirmeSayisi)} />
                </View>
                ...
                <View style={styles.dateBox}>
                    <DetailRow label="Oluşturma" value={tarihFormatla(detay.olusturmaTarihi)} />
                    <DetailRow
                        label="Güncelleme"
                        value={
                            detay.guncellemeTarihi
                                ? tarihFormatla(detay.guncellemeTarihi)
                                : "Bilgi yok"
                        }
                    />
                </View>
...
// Tarih ve benzeri satır bilgisini label/value olarak gösterir.
...
function BolumKart({ bolum }: { bolum: MobileAdminKursBolumItem }) {
    return (
        <View style={styles.sectionCard}>
            <View style={styles.sectionTop}>
                ...
                <View style={styles.sectionInfo}>
                    ...
                    <Text style={styles.sectionCardSubText}>{bolum.dersSayisi} ders</Text>
                </View>
            </View>
...
function DersSatiri({ ders }: { ders: MobileAdminKursDersItem }) {
    return (
...
// Bölüm veya ders bulunmadığında küçük boş durum kartı.
